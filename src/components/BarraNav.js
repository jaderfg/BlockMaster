            ...
            <Nav className="mb-5 text-Light px-5 py-3 nav">
                <Categorias className="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <Link to="/" className="nav-link">
                        <img src="https://res.cloudinary.com/jadergomez/image/upload/v1643660110/logo-blockBuster_vbv5wx.png"
                        width="106px" alt=''/>
                    </Link> 
                ...
                <Link to="/Login" className="nav-link text-light align-self-center">Login</Link>
